...
} from "@/lib/portal-integrations/immobilien-de-openimmo-candidate.server";

import {
  buildImmobilienDeOpenImmoXmlV1,
} from "@/lib/portal-integrations/immobilien-de-openimmo-xml.server";
...
export async function GET(
  ...
  try {
    ...
    /*
     * Immobilien.de Provider-ID-Profil
...
contactName:
    ...
    return NextResponse.json({
       ...
       * Immobilien.de Partnerprofil.
       */
      localXmlGenerationOnly:
        true,

      portalProfileVerified:
        openImmoXml.portalProfileVerified,
    ...
    console.error(
      "[immobilien-de] OpenImmo dry-run failed",
      error
    );
    ...
    return NextResponse.json(
      {
        ...
        error:
          "IMMOBILIEN_DE_OPENIMMO_DRY_RUN_FAILED",
