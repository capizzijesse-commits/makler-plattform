...
const STYLES = {
  modern:
    "modern, warm, elegant and suitable for a high-quality Swiss property listing",
  scandinavian:
    "Scandinavian, bright, natural, calm and welcoming",
  luxurious:
    "luxurious, sophisticated, tasteful and restrained, without appearing excessive",
  minimalist:
    "minimalist, spacious, functional, calm and refined",
} as const;
...
export async function POST(
  ...
  try {
    ...
    const sourceFileName =
      ...
      `original-${sourceImage.id}.${extensionForMimeType(
        mimeType
      )}`;
    ...
    formData.append(
      "prompt",
      createStagingPrompt(roomType, style)
    );
