...
export default function ReconciliationAlertCard() {
  ...
  async function resolveJob(
    ...
    const confirmationText =
      confirmedPublished
        ? "BestÃ¤tige nur, wenn du direkt auf der Social-Plattform geprÃ¼ft hast, dass dieser Post bereits verÃ¶ffentlicht wurde. Inserat-AI sendet dabei nichts erneut."
        : "BestÃ¤tige nur, wenn du direkt auf der Social-Plattform geprÃ¼ft hast, dass dieser Post NICHT verÃ¶ffentlicht wurde. Der alte Job bleibt gestoppt und wird nicht automatisch erneut gesendet.";
    ...
    try {
      ...
      setResolutionError(
        "Die manuelle PrÃ¼fung konnte nicht gespeichert werden. Bitte erneut prÃ¼fen und spÃ¤ter nochmals versuchen."
      );
    }
    finally {
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="text-sm font-black text-white">
              Publishing-Status konnte nicht geprÃ¼ft werden
            </div>

            <p className="mt-1 text-sm leading-6 text-slate-300">
              Die Statusanzeige ist momentan nicht verfÃ¼gbar.
              Es wurde dadurch keine VerÃ¶ffentlichung ausgelÃ¶st.
            </p>
          </div>
        </div>
      </section>
  ...
  return (
    <section className="mb-6 rounded-[20px] border border-amber-400/40 bg-amber-500/10 p-5 shadow-[0_16px_45px_rgba(245,158,11,0.10)]">
        ...
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-300">
              Inserat-AI konnte bei einer VerÃ¶ffentlichung nicht eindeutig
              bestÃ¤tigen, ob der Social-Post bereits verÃ¶ffentlicht wurde.
      ...
      <div className="mt-4 rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 text-xs leading-5 text-slate-300">
        Bitte diesen Post nicht erneut senden, bis der Status sicher geprÃ¼ft
        wurde. Inserat-AI verÃ¶ffentlicht ihn nicht automatisch ein zweites Mal.
      </div>
    </section>
  );
}
